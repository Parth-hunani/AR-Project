                    ...
                    <div className="col-9 only_winfo">
                        <div className="productlists booking_info_right">
                            ...
                            <div className="Promotions_infoboxs">
                                <h5 style={{color: "#000"}}>What type of appointment do you want to book?</h5>
                                <div className="row tow_buttones">
                                    <div className="col-4">
                                        <Link variant="outline-primary" className="choicsbtn" to="/AR/booking-inperson">In Person</Link>{' '}
                                    </div>
                                    <div className="col-4">
                                        <Link variant="outline-primary" className="choicsbtn" to="/AR/booking-system-setup-thrd">Virtual</Link>{' '}
                                    </div>
                                    <div className="col-4">
                                    </div>
                                </div>
                                ...
                                <div className="row thrd_boxes">
                                        ...
                                        <div className="provider_name_info">
                                            <div className="provider_icon_name">
                                                <div className="provider_dps">
                                                    <h5 style={{color: "#525252"}}>Partial Face Wrinkle Relaxers-Jeuveau/Dysport/ Botox (1 -2 areas)</h5>
                                                </div>
                                            </div>
                                            <div className="provider">
                                                <h6>Wrinkle relaxers are FDA indicated to last 3-4
                                                    months and results from this treatment are see....<Link to="" style={{color: "#68C9CC"}}>Read more</Link>
                                                </h6>
                                            </div>
                                    ...
                                    <div className="col" style={{background: "#68c9cc2e"}} >
                                        <div className="provider_name_info">
                                            <div className="provider_icon_name">
                                                <div className="provider_dps">
                                                    <h5 style={{color: "#525252"}}>Wrinkle Relaxers for Hyperhidrosis</h5>
                                                </div>
                                            </div>
                                            <div className="provider">
                                                <h6>Wrinkle relaxers are FDA indicated to last 3-4
                            ...
                            <div className="priview_next">
                                <div className="row">
                                    <div className="col">
                                        <Link class="buttons_sites_all" to="/AR/booking-system-setup-one">&#8249; &nbsp; Previous</Link>
                                    </div>
                                    <div className="col butn_end">
                                        <Link class="buttons_sites_all" to="/AR/booking-system-setup-thrd">Next &nbsp; &#8250;</Link>
                                    </div>
                                </div>
                            </div>
                        </div>    

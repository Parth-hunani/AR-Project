                                    ...
                                    <Row className="otp_number_butoon">
                                        <Col>
                                            <Row id="otpnumber">
                                                ...
                                                <span>Didn’t get the code?<Link to="" style={{color: "#68C9CC"}}>Resend OTP</Link></span>
                                            </Row>
                                        </Col>
                                        <Col className="next_buttons">
                                            <Link to="/AR/booking-system-setup-two" className="menu_list_cro active">&nbsp;&nbsp;&nbsp;&nbsp;Verify&nbsp;&nbsp;&nbsp;&nbsp;</Link>
                                        </Col>
                                    </Row>
                                    <Row className="otp_number_butoon">
                                        <Col>
                                        ...
                                        <Col className="next_buttons">
                                            <Link to="/AR/booking-system-setup-thrd" className="menu_list_cro active">&nbsp;&nbsp;&nbsp;&nbsp;Next &nbsp; &#8250;&nbsp;</Link>
                                        </Col>
                                    </Row>
                                </Form>
                            </div>

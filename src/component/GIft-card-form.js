                        ...
                        <div className="productlists booking_info_right">
                            ...
                            <div className="Promotions_infoboxs">
                                ...
                                <div className="row">
                                        ...
                                        <div className="gift_forms mt-5">
                                            <Form>
                                                ...
                                                <Form.Group className="mb-4" controlId="exampleForm.ControlInput1">
                                                    ...
                                                    <Form.Control type="email" placeholder="jane.doe@domain.com" />
                                                </Form.Group>
                                                <Form.Group className="mb-4" controlId="exampleForm.ControlInput1">
                                                ...
                                                <Form.Group className="mb-4" controlId="exampleForm.ControlTextarea1">
                                                    ...
                                                    <Form.Control as="textarea" rows={6} placeholder="Have a great birthday! Can’t wait to meet again!" />
                                                </Form.Group>
                                    ...
                                    <div className="col-3 blanck_col">
